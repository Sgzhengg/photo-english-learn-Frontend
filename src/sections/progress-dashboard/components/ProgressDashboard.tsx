import { Calendar, BookOpen, Target, Award, TrendingUp, Flame, Clock, Tag } from 'lucide-react'
import type { OverviewStats, WordStats, RecentActivity, Achievement, ChartData } from '@/../product/sections/progress-dashboard/types'

// 学习概览卡片
function OverviewCards({ overviewStats }: { overviewStats: OverviewStats }) {
  return (
...
// 掌握程度分布
function MasteryDistribution({ wordStats }: { wordStats: WordStats }) {
...
// 标签统计
function TagStats({ wordStats }: { wordStats: WordStats }) {
  return (
    <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border-2 border-slate-200 dark:border-slate-700">
...
// 最近活动时间线
function ActivityTimeline({ recentActivity }: { recentActivity: RecentActivity[] }) {
  const activityIcons = {
    photo: '📸',
    practice: '✏️',
    review: '🔄',
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 pb-safe">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border-2 border-slate-200 dark:border-slate-700">
          ...
          <SimpleBarChart data={recentActivityData} />
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border-2 border-slate-200 dark:border-slate-700">
          ...
          <SimpleBarChart data={recentAccuracyData} />
        </div>
