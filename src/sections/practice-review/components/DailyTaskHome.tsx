import { Play, Calendar, TrendingUp, BookOpen, Clock, Target, CheckCircle2 } from 'lucide-react'
import type { DailyTask, MasteryLevel, ProgressStats } from '@/../product/sections/practice-review/types'
