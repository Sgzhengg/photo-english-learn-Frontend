...
export function AppShell({
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 dark:bg-slate-900">
      {/* Mobile Container - Centered on desktop with max width */}
      <div className="relative mx-auto w-full max-w-md bg-white dark:bg-slate-900 shadow-2xl min-h-screen">
        {/* Top Header */}
        ...
        {/* Main Content Area */}
        <main className="flex-1 pb-20 pt-14 min-h-screen">
          {children}
        </main>
